...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storesProductStore = __webpack_require__(4);

	var _storesProductStore2 = _interopRequireDefault(_storesProductStore);

	var _storesCartStore = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = (0, _nuclearJs.Store)({
		...
		initialize: function initialize() {
			this.on(_actionTypes.RECEIVE_PRODUCTS, receiveProducts);
			this.on(_actionTypes.ADD_TO_CART, decrementInventory);
		}
	});
	 ...
	 */
	function receiveProducts(state, _ref) {
		var products = _ref.products;

		var newProducts = (0, _nuclearJs.toImmutable)(products).toMap().mapKeys(function (k, v) {
			return v.get('id');
		});
	 ...
	 * inventory.
	 */
	function decrementInventory(state, _ref2) {
		var product = _ref2.product;

		return state.update(product.id, function (product) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = (0, _nuclearJs.Store)({
		getInitialState: function getInitialState() {
			return (0, _nuclearJs.toImmutable)({ itemQty: {} });
		},

		initialize: function initialize() {
			this.on(_actionTypes.ADD_TO_CART, addToCart);
		}
	});
	 ...
	 * a new item to 1.
	 */
	function addToCart(state, _ref) {
		var product = _ref.product;

		var id = product.id;
		return state.hasIn(['itemQty', id]) ? state.updateIn(['itemQty', id], function (quantity) {
			return quantity + 1;
